...
class Solution:
    ...
    def execute(self):
        ...
        print("LAST STEP OF DOUBLE PROBLEM PREPARE:\n")
        ...
        print("Прямая\n", tabulate(self.__simplex_method(self.__create_main(self.__c, self.__b), m=9, n=15),
                                   tablefmt="latex", floatfmt=".2f"))
        print("Двойственная\n", tabulate(self.__simplex_method(double_mat, m=7, n=15), tablefmt="latex", floatfmt=".2f"))
